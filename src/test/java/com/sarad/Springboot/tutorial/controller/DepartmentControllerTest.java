...
class DepartmentControllerTest {
    ...
    @BeforeEach
    void setUp() {
        department = Department.builder().departmentName("IT").departmentAddress("Kathmandu").departmentCode("IT-09").departmentId(1L).build();
    }

    @Test
    void saveDepartment() throws Exception {
        Department inputDepartment = Department.builder().departmentName("IT").departmentAddress("Kathmandu").departmentCode("IT-09").build();
